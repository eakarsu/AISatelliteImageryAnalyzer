...
const FEATURE_SLUG = 'no-imagery-provider-api-planet-maxar-sentine';
const FEATURE_TITLE = 'No imagery provider API (Planet, Maxar, Sentinel-2)';
const PROJECT = 'AISatelliteImageryAnalyzer';
